...
installer (on Windows) or just copy over `/Applications/Romance-Qt` (on Mac)
or `romanced`/`romance-qt` (on Linux).
...
- #14698 `ec71f06` Add romance-tx.exe into Windows installer (ken2812221)
