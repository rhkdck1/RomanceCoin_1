...
* bitcoin.conf: contains configuration settings for romanced or romance-qt
* romanced.pid: stores the process id of romanced while running
...
* debug.log: contains debug information and general logging generated by romanced or romance-qt
