...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-logtimeromances", strprintf("Add romancesecond precision to debug timestamps (default: %u)", DEFAULT_LOGTIMEMICROS), true, OptionsCategory::DEBUG_TEST);
...
void InitLogging()
{
    ...
    g_logger->m_log_time_micros = gArgs.GetBoolArg("-logtimeromances", DEFAULT_LOGTIMEMICROS);
